...
import { Eye, Pencil, Trash2, RefreshCw, ChevronUp, ChevronDown, ChevronsUpDown } from 'lucide-react'
                    ...
                    return (
                        <div className="flex items-center justify-end space-x-1">
                            ...
                            <Link
                                ...
                                method="post" as="button" title="Reset Tes"
                            ...
                            <Link
                                href={`/admin/siswa-riasec/${item.id}`}
                                method="delete" as="button" title="Hapus Siswa"
                        ...
                        {table.getHeaderGroups().map((headerGroup) => (
                            <tr key={headerGroup.id}>
                                {headerGroup.headers.map((header) => (
                                    <th key={header.id} className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider" style={{ width: header.getSize() !== 150 ? header.getSize() : undefined }}>
                                        {header.isPlaceholder ? null : (
                                            ...
                                            >
                                                ...
                                                }[header.column.getIsSorted() as string] ?? (header.column.getCanSort() ? <ChevronsUpDown size={16} /> : null)}
                                            </div>
                                        )}
                                    </th>
                                ))}
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="flex items-center gap-1 text-sm">
                        ...
                        <input
                            ...
                            className="border p-1 rounded w-16 dark:bg-gray-700"
                        />
                    </span>
                </div>
            </div>
